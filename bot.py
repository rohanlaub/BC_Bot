...
def run_discord_bot():
  ...
  async def on_member_join(member):
    ...
    await channel.send(
      f'{member.mention} welcome to the Belgium Campus Discord.\n\n'
    ...
    if message_id == 1074745907507118250:
      ...
      if role is not None:
        ...
        if member is not None:
          ...
          print(
            f'{member.display_name}#{member.discriminator} has been given the {role} role.'
          )
        else:
    ...
    if message_id == 1074745907507118250:
      ...
      if role is not None:
        ...
        if member is not None:
          ...
          print(
            f'{role} has been revoked from {member.display_name}#{member.discriminator}.'
          )
        else:
          print('Member not found.')
      else:
